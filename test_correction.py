#!/usr/bin/env python3
"""
Script de test pour vérifier la correction avec a=34mm, N=60, R=10mm
"""
import numpy as py
...
print("="*70)
print(" TEST AVEC CORRECTION DU FACTEUR 2π")
print("="*70)
print(f"Paramètres: R={R*1000:.1f}mm, a={a*1000:.1f}mm, N={N}")
print(f"R_int={R_int*1000:.2f}mm, pas_ailette={pas_ailette*1000:.2f}mm")
print("="*70)
...
print(f"Flux imposé: σ_i = {sigma_i:.2f} W/m²")
...
if Resoudre:
    ...
    for ie in range(ne):
        ...
        # CORRECTION: Ajout du facteur 2π
    ...
    print("\n" + "="*70)
    print(" RÉSULTATS AVEC CORRECTION")
    print("="*70)
    ...
    print(f"\n  Comparaison avec Ansys:")
    print(f"    Ansys:  250°C")
    print(f"    Python: {Tmax:.2f}°C")
    print(f"    Écart:  {abs(Tmax-250):.2f}°C ({abs(Tmax-250)/250*100:.1f}%)")
    print("="*70)
