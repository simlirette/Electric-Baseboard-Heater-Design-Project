#!/usr/bin/env python3
"""
Test: Le flux σi du PDF inclut peut-être déjà le facteur 2π
Donc ne PAS le remultiplier dans le code pour le flux
"""
import numpy as py
...
print("="*70)
print(" TEST: Flux SANS facteur 2π (conduction/convection AVEC 2π)")
print("="*70)
...
if Resoudre:
    ...
    for fi in range(nflux):
        ...
        # SANS 2π pour le flux (hypothèse: σi inclut déjà 2π)
