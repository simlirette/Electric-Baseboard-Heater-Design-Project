...
# Test: Ajouter 2π PARTOUT dans les formules axisymétriques
...
print("="*70)
print(" TEST AVEC FACTEUR 2π EXPLICITE PARTOUT")
print("="*70)
print(f"Paramètres: R={R*1000}mm, a={a*1000}mm, N={N}")
print("="*70)
...
print(f"Flux calculé: σ_i = {sigma_i:.2f} W/m²")
...
print("\n" + "="*70)
print(" RÉSULTATS AVEC 2π PARTOUT")
print("="*70)
...
print(f"    Écart:  {abs(Tmax-279):.2f}°C ({abs(Tmax-279)/279*100:.1f}%)")
print("="*70)
